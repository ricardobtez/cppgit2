...
odb::backend odb::create_backend_for_loose_objects(
...
odb::backend odb::create_backend_for_one_packfile(
...
std::pair<size_t, cppgit2::object::object_type> odb::read_header(
    const oid& id) const {
  size_t length_out;
...
std::tuple<odb::stream, size_t, cppgit2::object::object_type> odb::open_rstream(
    const oid& id) {
